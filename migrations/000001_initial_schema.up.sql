...
CREATE TABLE IF NOT EXISTS eligibilities (
    ...
    academic_fees BOOLEAN NOT NULL DEFAULT FALSE,
    laboratory_fees BOOLEAN NOT NULL DEFAULT FALSE,
    access_fees BOOLEAN NOT NULL DEFAULT FALSE,
...
-- =========================================================
-- CREATE EVALUATION ANSWERS TABLE
-- =========================================================
