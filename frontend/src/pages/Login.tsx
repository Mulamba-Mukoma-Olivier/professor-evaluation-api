    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f4f7fb] p-4 sm:p-6">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-slate-300/40 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        {/* =====================================================
            LEFT PANEL
        ===================================================== */}
        <div className="relative hidden min-h-[650px] overflow-hidden bg-[#0b1220] p-8 text-white lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative max-w-md">
            ...
            <p className="mt-5 max-w-sm text-sm leading-6 text-slate-400">
              A centralized platform for managing professor
              evaluations and monitoring academic performance.
            </p>
            ...
            <div className="mt-8 space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm text-slate-300">
                ...
                <span>Structured professor evaluations</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-sm text-slate-300">
                ...
                <span>Centralized academic data</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-sm text-slate-300">
                ...
                <span>Clear performance insights</span>
              </div>
        ...
        {/* =====================================================
            RIGHT PANEL
        ===================================================== */}
        <div className="flex min-h-[650px] items-center justify-center bg-white p-6 sm:p-10 lg:p-12">
